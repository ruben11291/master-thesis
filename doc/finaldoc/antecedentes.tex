...
\item \emph{GeoServer:} is a Java-based software server for cataloguing and
  ...
  multiplatform, open source and it can receive data from other sources. Also,
  it can be integrated with \emph{GeoNetwork}.
%http://geonetwork-opensource.org/
\item \emph{GeoNetwork:} is a Java-based and platform independent catalogue application to manage
  geospatial images. It uses \ac{OGC} standards as \ac{CSW}, \ac{WMS} and \ac
  {WCS} among others interchanges protocols. It catalogues data from sources but
  it not maintains its data. This is the reason for \emph{GeoServer} was selected.
\end{itemize}
