...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{implementationVWBF/gs-sat.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=1\textwidth]{implementationVWBF/nodes-vw.png}
...
The script that perform the above is showed in Listing~\emph{code:impl-rspec-gs-sim}.
