...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=6.20079in,height=1.79134in]{planetlab/ple-layer1-nodes.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=6.1375in,height=2.1375in]{planetlab/ple-layer2-nodes.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=4.01423in,height=2.11349in]{planetlab/ple-layer2-nodes.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.2\textwidth]{planetlab/modelled-links.png}
\caption{(a)}
\label{fig:ple-modelled-links}
\end{center}
\end{figure}
