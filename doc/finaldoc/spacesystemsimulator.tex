...
As an example, the following data was obtained from ``Scenario 2: Infrastructure monitoring affection in railway infrastructures by sand movement in desert areas'':
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.8\textwidth]{spaceSystemSimulator/database-architecture.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{spaceSystemSimulator/sat-simulator-workflow.jpg}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.8\textwidth]{spaceSystemSimulator/sheduling-process.jpg}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{spaceSystemSimulator/ground-station-workflow.jpg}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{spaceSystemSimulator/ground-station-activity.jpg}
